...
GPU_MODEL_REGISTRY = {
    ...
    "EleutherAI/pythia-6.9b": {
        "local_name": "EleutherAI--pythia-6.9b",  # Match downloaded dir name
        "role": "target",
        "tier": "required",
        "gpu_only": True,
        "size": "6.9B",
    ...
    "microsoft/deberta-v3-large": {
        "local_name": "microsoft--deberta-v3-large",
        "role": "judge",
        "tier": "required",
        "gpu_only": False,
        "size": "435M",
    ...
    "mistralai/Mistral-7B-Instruct-v0.2": {
        "local_name": "mistralai--Mistral-7B-Instruct-v0.2",
        "role": "target",
        "tier": "recommended",
        "gpu_only": True,
        "size": "7B",
    ...
    "meta-llama/Llama-2-7b-chat-hf": {
        "local_name": "meta-llama--Llama-2-7b-chat-hf",
        "role": "target",
        "tier": "recommended",
        "gpu_only": True,
        "size": "7B",
    ...
    "EleutherAI/pythia-12b": {
        "local_name": "EleutherAI--pythia-12b",
        "role": "target",
        "tier": "optional",
        "gpu_only": True,
        "size": "12B",
